...
export const ImageItemSchema = z.object({
  ...
  mime: z.string().describe('The mime type of this image.'),
  url: z
    .url()
    .optional()
    .describe('The url pointing to the image we should display.'),
  height: z
    .number()
    .optional()
    .describe(
...
export const ImageBlockElementSchema = BlockBaseSchema.extend({
  ...
  items: z
    ...
    .describe('The list of images that compose this image block.'),
  layout: z
    .enum(['grid', 'carousel'])
    .optional()
    .describe(
