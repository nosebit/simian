 ...
 */
const ContextProvider: ImageBlockAddon["ContextProvider"] = ({ addon, children }) => (
  <ImageBlockContext.Provider value={{
...
const Companion: ImageBlockAddon["Companion"] = () => {
  ...
  return (
    <div id={`image-fullscreen-root-${editor.id}`} />
  );
};
        ...
        Editor.withoutNormalizing(editor, () => {
          if (isAtStart && isAtEnd) {
            ...
            if (hasNextNode) {
              ...
              Transforms.insertNodes(editor, imageNode as Node, { at: blockPath });
              Transforms.select(editor, Editor.start(editor, nextPath));
            }
          } else {
            /**
            ...
            // Insert image
            Transforms.insertNodes(editor, imageNode as Node, { at: newBlockPath });
 ...
 */
const onKeyDown: ImageBlockAddon["onKeyDown"] = ({ editor, selection }, evt) => {
