...
export const imageBlock: SlashAddonCommandFactory<"image-block", "media"> = ({t, ...ctx}) => ({
  id: "image-block",
...
export type ImageBlockSlashCommandIds = ReturnType<(typeof slashCommands)[number]>["id"];
