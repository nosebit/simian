...
const ContextProvider: LatexBlockAddon["ContextProvider"] = ({ children }) => {
  ...
  return (
    <LatexBlockContext.Provider value={{
      equationMap,
    }}>
      {children}
 ...
 */
const normalizeNode: LatexBlockAddon["normalizeNode"] = ({ editor }, [node, path]) => {
  if (
 ...
 */
const onKeyDown: LatexBlockAddon["onKeyDown"] = ({ editor, selection }, evt) => {
