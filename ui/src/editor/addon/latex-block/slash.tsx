...
export const latexBlock: SlashAddonCommandFactory<"latex-block", "nerd"> = ({t, ...ctx}) => ({
  id: "latex-block",
  icon: <SquareSigma />,
...
export type LatexBlockSlashCommandIds = ReturnType<(typeof slashCommands)[number]>["id"];
